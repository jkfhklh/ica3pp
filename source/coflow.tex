...
We next evaluate the performance (i.e., average JCT) of our scheduler with other baseline schedulers with different parameters ($\alpha$ and $\beta$). Because of small jobs are in the majority of all jobs (60\% of all), %In curious of how far all these schedulers are from optimal, 
